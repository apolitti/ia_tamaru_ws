  ...
  try
    ...
    try
      ...
      begin
        ...
        SQL.Add('select lst.*');
        SQL.Add('     , decode(lst.avr_bo_itemaberto,''S'',''Sim'',''Não'') as avr_bo_itemaberto_dsc');
        SQL.Add('     , decode(lst.avr_bo_itemdivergente,''S'',''Sim'',''Não'') as avr_bo_itemdivergente_dsc');
        SQL.Add('     , decode(lst.avr_bo_estoque,''S'',''Sim'',''Não'') as avr_bo_estoque');
